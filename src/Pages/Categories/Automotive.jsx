...
const Helmet = () => {
  const cardData = [
    {
      id: 1,
      image: 'https://media.istockphoto.com/id/486231688/vector/vector-car-spares-concept-with-wheel.jpg?s=612x612&w=0&k=20&c=ERgohlqMxmc97H06cVLePr_7fl8lV4A3zWOoguf7KLE=',
    },
    {
      id: 2,
